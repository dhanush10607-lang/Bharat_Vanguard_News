      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted mt-1 text-sm">
            {mode === 'login'
              ? 'Sign in to your TruthLens AI account'
              : 'Join TruthLens AI for free'}
          </p>
        </div>
        ...
        <div className="card p-6">
          ...
          <button
            ...
            className="btn-google mb-4 relative"
          >
            {googleLoading ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {mode === 'register' && (
              <>
                <div>
                  <label className="block text-xs text-text-muted mb-1.5" htmlFor="display_name">
                    Full name
                  </label>
                ...
                <div>
                  <label className="block text-xs text-text-muted mb-1.5" htmlFor="username">
                    Username
                  </label>
                  <div className="relative">
