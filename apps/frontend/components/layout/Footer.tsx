        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center mb-4 w-fit group">
              <img src="/BVNlogo.svg" alt="Bharat Vanguard News" className="h-12 sm:h-10 md:h-11 lg:h-12 w-auto grayscale group-hover:grayscale-0 opacity-70 group-hover:opacity-100 transition-all" />
            </Link>
