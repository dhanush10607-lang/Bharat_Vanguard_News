      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4 w-fit group">
              ...
              <span className="font-bold text-lg">
                <span className="text-gradient-blue">TruthLens</span>
                <span className="text-text-muted font-normal"> AI</span>
              </span>
            </Link>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-border">
          <p className="text-xs text-text-muted">
            © {new Date().getFullYear()} TruthLens AI. Built with transparency.
          </p>
